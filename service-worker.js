...
const APP_SHELL_FILES = [
  ...
  "./js/auth.js",
  "./js/db.js",
  "./js/karte-name-match.js",
  "./js/exam-plan-ui.js",
  "./js/meds-ui.js",
  "./js/freq-picker.js",
  "./js/history-ui.js",
  "./js/history-kinds.js",
  "./js/history-disease-seed.js",
  "./js/history-item-match.js",
  "./js/procedures-ui.js",
  "./js/special-notes-ui.js",
  "./js/migration-progress-ui.js",
  "./js/bulk-register-ui.js",
  "./js/api-key.js",
  "./js/anthropic.js",
  "./js/exam-item-match.js",
  "./js/med-item-match.js",
  "./js/chip-detect.js",
  "./js/ai-suggest-ui.js",
  "./js/feature-flags.js",
  "./js/settings-ui.js",
  "./js/master-delete-ui.js",
  "./js/free-qa-ui.js",
  "./js/app-version.js",
  "./js/sw-update.js",
  "./js/passcode-auth.js",
  ...
  "./js/row-gestures.js",
  "./js/ime-keys.js",
  "./js/right-tab-alerts.js",
  "./js/chart-search-ui.js",
  "./js/status-mode-ui.js",
  "./js/input-mode-ui.js",
  "./js/headline-emoji.js",
  "./js/app.js",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
