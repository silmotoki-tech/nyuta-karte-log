...
export const FULL_EXAM_MASTER = [
  ...
  { id: "seed-other-chest-set", label: "胸部スク", category: "imaging", kind: "leaf", parentId: "" },
  { id: "seed-other-abdomen-set", label: "腹部スク", category: "imaging", kind: "leaf", parentId: "" },
  { id: "seed-imaging-full-scr", label: "全スク", category: "imaging", kind: "leaf", parentId: "" },
  { id: "seed-imaging-abdomen-echo", label: "腹部エコー", category: "imaging", kind: "leaf", parentId: "" },
  { id: "seed-imaging-heart-echo", label: "心エコー", category: "imaging", kind: "leaf", parentId: "" },
...
const cases = [
  ...
  { group: "独立・画像", query: "レントゲン撮影", expectAny: ["胸部スク", "腹部スク", "全スク"] },
  { group: "独立・病理", query: "病理検査に出した", expectAny: ["組織検査", "細胞診(院内)", "細胞診(外注)"] },
  { group: "脂質内訳", query: "TGが高値", expectAll: ["TG"] },
  { group: "独立・画像", query: "心エコー実施", expectAll: ["心エコー"] },
  { group: "独立・画像", query: "腹部エコー", expectAll: ["腹部エコー"] },
  ...
  { group: "略称・言い換え", query: "腹エコー", expectAll: ["腹部エコー"] },
  { group: "略称・言い換え", query: "胸写", expectAll: ["胸部スク"] },
];
