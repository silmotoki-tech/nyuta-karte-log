...
const cases = [
  ...
  { group: "独立・血液", query: "血液検査した", expectAny: ["CBC", "血糖(アントセンス)"] },
  {
    group: "独立・画像",
    query: "レントゲン撮影",
    expectAny: ["胸部", "腹部", "胸部set", "腹部set", "全set"],
  },
  ...
  { group: "脂質内訳", query: "TGが高値", expectAll: ["TG"] },
  {
    group: "独立・画像",
    query: "心エコー実施",
    expectAny: ["スクリーニング", "流速あり", "拡大チェック"],
  },
  {
    group: "独立・画像",
    query: "腹部エコー",
    expectAny: ["スクリーニング", "脾臓", "肝臓", "腎臓", "尿管", "膀胱", "前立腺"],
  },
  {
    group: "独立・画像",
    query: "胸部X線",
