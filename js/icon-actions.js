...
/**
 * @param {{ action: "edit"|"delete"|"refresh", title: string, onClick?: (e: Event) => void, className?: string }} opts
 */
...
/**
 * @param {Array<{ action: "edit"|"delete"|"refresh", title: string, onClick?: (e: Event) => void, className?: string } | null | undefined>} items
